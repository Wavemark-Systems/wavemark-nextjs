...
const translations = {
  en: {
    ...
    vivienSpecialty1: pagesEn.team.vivien.specialties[0],
    vivienSpecialty2: pagesEn.team.vivien.specialties[1],
    vivienSpecialty3: pagesEn.team.vivien.specialties[2],
    markRole: pagesEn.team.mark.role,
    markName: pagesEn.team.mark.name,
    markDescription: pagesEn.team.mark.description,
    markSpecialty1: pagesEn.team.mark.specialties[0],
    markSpecialty2: pagesEn.team.mark.specialties[1],
    markSpecialty3: pagesEn.team.mark.specialties[2],
    // Mission
  ...
  lb: {
    ...
    vivienSpecialty1: pagesLb.team.vivien.specialties[0],
    vivienSpecialty2: pagesLb.team.vivien.specialties[1],
    vivienSpecialty3: pagesLb.team.vivien.specialties[2],
    markRole: pagesLb.team.mark.role,
    markName: pagesLb.team.mark.name,
    markDescription: pagesLb.team.mark.description,
    markSpecialty1: pagesLb.team.mark.specialties[0],
    markSpecialty2: pagesLb.team.mark.specialties[1],
    markSpecialty3: pagesLb.team.mark.specialties[2],
    // Mission
